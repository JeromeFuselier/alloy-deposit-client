...
public class OptUrlFrame extends JFrame implements ActionListener {
	private static final Log log = LogFactory.getLog(OptUrlFrame.class);
	...
	public OptUrlFrame(BagView bagView, String title) {
        super(title);
    ...
    private JPanel createComponents() {
		...
		titlePane.setMessage( new DefaultMessage("Modify server URL"));
		...
		urlField = new JTextField(SwordClient.server_url);
        ...
        buildConstraints(glbc, 2, row, 1, 1, 40, 100, GridBagConstraints.HORIZONTAL, GridBagConstraints.EAST); 
    ...
    private class OkHandler extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			SwordClient.server_url = urlField.getText();
