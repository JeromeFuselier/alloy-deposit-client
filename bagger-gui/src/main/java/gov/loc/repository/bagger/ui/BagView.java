...
import gov.loc.repository.bagger.ui.handlers.SendSIPExecutor;
...
public class BagView extends AbstractView implements ApplicationListener {
    ...
    public void enableBagSettings(boolean b) {
        ...
        if (b) {
	    	bagPayloadTree.setDragEnabled(false);
	    	bagPayloadTree.setDropMode(DropMode.ON_OR_INSERT);
	    	bagPayloadTree.setTransferHandler(new PayLoadTreeTransferHandler(true, this));
        }
    }
    ...
    private void initializeCommands() {
        ...
        sendSIPExecutor.setEnabled(false);
    }
