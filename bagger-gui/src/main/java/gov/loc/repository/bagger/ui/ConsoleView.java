...
public class ConsoleView extends AbstractView {
	...
	protected void registerLocalCommandExecutors(PageComponentContext context) {
    	...
    	context.register("sendSIPCommand", BagView.instance.sendSIPExecutor);
    	context.register("getServiceDocumentCommand", BagView.instance.getServiceDocumentExecutor);
	}
