...
public class BaggerLifecycleAdvisor extends DefaultApplicationLifecycleAdvisor
{
    ...
    public void onPreStartup()
    {
    	...
    	if(getApplication().getApplicationContext().containsBean("proxyPage"));
    	{
    		...
    		/*System.out.println("++++++++++++++++++++++++");
    		System.out.println(dockingPageDesc);
    		
    		
    		VLDockingViewDescriptor consoleView = (VLDockingViewDescriptor)getApplication().getApplicationContext().getBean("consoleView");

    		System.out.println("++++++++++++++++++++++++");
    		System.out.println(consoleView);
    		consoleView.setAutoHideEnabled(true);
    		System.out.println(consoleView.isAutoHideEnabled());
